...
class CacheUtils {
    ...
    public function get_parent($woeid) {
        ...
        // $select = $this->db->prepare($sql);
        // $select->execute(array(':woeid' => $woeid));
        // $ret = $select->fetch(\PDO::FETCH_ASSOC);
        // if ($ret) {
        //     return $ret['parent'];
        // }
    ...
    public function insert_place($doc) {
        ...
        foreach ($doc as $key => $value) {
            $fields[] = $key;
            $keys[] = ':' . $key;
            $values[':' . $key] = array('value' => $value, 'type' => $this->fields['places'][$key]);
        }
    ...
    public function insert_alias($doc) {
        ...
        foreach ($doc as $key => $value) {
            $fields[] = $key;
            $keys[] = ':' . $key;
            $values[':' . $key] = array('value' => $value, 'type' => $this->fields['aliases'][$key]);
        }
    ...
    public function insert_admin($doc) {
        ...
        foreach ($doc as $key => $value) {
            $fields[] = $key;
            $keys[] = ':' . $key;
            $values[':' . $key] = array('value' => $value, 'type' => $this->fields['admins'][$key]);
        }
    ...
    public function insert_country($doc) {
        ...
        foreach ($doc as $key => $value) {
            $fields[] = $key;
            $keys[] = ':' . $key;
            $values[':' . $key] = array('value' => $value, 'type' => $this->fields['countries'][$key]);
        }
